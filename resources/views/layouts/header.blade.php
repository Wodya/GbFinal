<nav class="nav m-0 border-bottom align-items-center">
    ...
    <button type="button" class=" button-as input-head-as input-head-3-as border border-color-green-as"><img src="img/search.png" alt="Поиск"></button>
    ...
    <div class="d-flex justify-content-start input-head-6-as border-start nav-element ps-2">
        <img src="img/icon/Status.png" class="ms-4 me-2">
        <p class="ps-0 m-0">Некрасов </p>
